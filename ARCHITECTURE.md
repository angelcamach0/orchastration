...
## Overview
Orchastration follows a small, layered layout that cleanly separates CLI entrypoints, application logic, configuration, logging, and OS-specific path handling.
